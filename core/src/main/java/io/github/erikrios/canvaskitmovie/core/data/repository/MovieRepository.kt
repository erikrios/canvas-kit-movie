...
class MovieRepository(
    ...
    override fun getMovies(): Flow<Resource<List<Movie>>> =
        object :
            io.github.erikrios.canvaskitmovie.core.data.NetworkBoundResource<List<Movie>, List<MovieResponse>>() {
    ...
    override fun getMovie(id: Int): Flow<Resource<Movie>> =
        object :
            io.github.erikrios.canvaskitmovie.core.data.NetworkBoundResource<Movie, MovieResponse>() {
